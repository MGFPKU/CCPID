...
## 中华人民共和国绿色主权债券框架 — EXCLUDE

- Requested item: 中华人民共和国绿色主权债券框架（财政部，2025 年 2 月发布；CCNT 双周检测轮 2026-09-09 检出，见 review/ccnt/tracking.csv）。
- Decision (17/09/2026): exclude.
- Reason: 框架为财政部针对中央人民政府自身绿色主权债券发行制定的内部治理文件（募集资金用途、项目评估与筛选、资金管理、报告、外部评审），仅约束发行人（政府自身），不向任何第三方施加义务、激励或信息要求，无受规制主体，不构成针对排放主体或其他市场主体的政策工具。其"项目评估与筛选"条款是发行人对自有项目获得绿色贴标资格的自我筛选（同类条款存在于所有企业绿色债券框架中），与公共评估规则相反——该组五项路径（战略环境评价、气候绩效评估考核、环境影响评价、投资项目节能减排评价、环境合规审计）均为政府向第三方（规划编制机关、建设单位、各级政府与公共机构、特定工业设施）施加评估/审计义务、并以审批或问责为条件的工具。主权绿色债券仅对既定预算支出进行融资与贴标，不改变绿色投资的规模与性质；其减缓效果经由政府投资传导，已由公共投资类工具（中央预算内投资专项、政府投资基金如国家绿色发展基金）覆盖，纳入将造成重复计算，并为纳入各类融资载体（超长期特别国债、专项债等）开先例。IFCMA 工具分类亦无对应类型。
- 若未来重新考虑纳入：最接近的槽位为 自愿措施/自愿性信息工具/自愿性信息披露（视作政府自愿承诺绿色信息披露标准），减缓相关性=间接，须设 review_flag；公共评估规则不适用（无第三方被评估），公共投资亦不宜（融资载体而非投资政策本身）。
