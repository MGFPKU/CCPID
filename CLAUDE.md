...
- **Mitigation co-benefits**: use only generalized phrases, never specific industry names or equipment/product types. CN vocabulary: 节能, 技术创新, 能源安全, 污染防治, 生态保护, 资源节约, 循环经济, 可再生能源发展, 公众健康, 适应气候变化, 就业和减贫, 产业发展, 生物多样性保护, 荒漠化防治, 绿色消费, 食品安全. EN: Energy conservation, Technological innovation, Energy security, Pollution control, Ecological protection, Resource conservation, Circular economy, Renewable energy development, Public health, Adaptation, Employment and poverty reduction, Industrial development, Biodiversity conservation, Desertification control, Green consumption, Food safety.
- **Objective (目标/Objective)**: short-goal vocabulary built on the mitigation co-benefit list above. Allowed CN values (join multiple with `；`): 减缓气候变化, 能源效率, 绿色经济, 保护臭氧层, 信息披露, 公众意识, 能力建设, plus the 16 co-benefit terms. EN equivalents (join with `; `): Climate change mitigation, Energy efficiency, Green economy, Ozone layer protection, Information disclosure, Public awareness, Capacity building, plus the 16 co-benefit EN terms. Any 碳中和/碳达峰/减碳/低碳 phrasing must be expressed as 减缓气候变化; never use free-text sentences.
...
- **作用渠道 (Functioning channel)**: single-select only. `供给侧`/`需求侧`/`环境` (Supply-side/demand-side/environment). 供给侧 = acts on production/supply behavior (polluting firms, ESCOs, generators, transport operators); 需求侧 = acts on consumption/purchase behavior — energy demand-side management (用能单位节能、能耗双控) and equipment buyers (households, farmers buying machinery); 环境 = establishes enabling conditions (evaluations, financial frameworks, voluntary standards, education).
