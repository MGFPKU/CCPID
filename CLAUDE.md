...
- **Mitigation co-benefits**: use only generalized phrases, never specific industry names or equipment/product types. CN vocabulary: 节能, 技术创新, 能源安全, 污染防治, 生态保护, 资源节约, 循环经济, 可再生能源发展, 公众健康, 适应气候变化, 就业和减贫, 产业发展, 生物多样性保护, 荒漠化防治, 绿色消费, 粮食安全. EN: Energy conservation, Technological innovation, Energy security, Pollution control, Ecological protection, Resource conservation, Circular economy, Renewable energy development, Public health, Climate change adaptation, Employment and poverty reduction, Industrial development, Biodiversity conservation, Desertification control, Green consumption, Food security.
- **Objective (目标/Objective)**: short-goal vocabulary of 19 terms, independent of the mitigation co-benefit list above. Allowed CN values (join multiple with `；`): 减缓气候变化, 非化石能源, 能源效率, 绿色经济, 技术创新, 能源安全, 污染防治, 生态保护, 生物多样性保护, 自然资源保护, 循环经济, 适应气候变化, 绿色金融, 电气化, 产业发展, 绿色消费, 信息披露, 公众意识, 保护臭氧层. EN equivalents (join with `; `): Climate change mitigation, Non-fossil energy, Energy efficiency, Green economy, Technological innovation, Energy security, Pollution control, Ecological protection, Biodiversity protection, Natural resource protection, Circular economy, Climate change adaptation, Green finance, Electrification, Industrial development, Green consumption, Information disclosure, Public awareness, Ozone layer protection. Any 碳中和/碳达峰/减碳/低碳 phrasing must be expressed as 减缓气候变化; never use free-text sentences.
